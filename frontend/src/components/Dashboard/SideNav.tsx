...
const SideNav: React.FC<SideNavProps> = ({ activePage, setActivePage }) => {
  ...
  const inactiveStyle =
    'text-foreground hover:text-primary hover:cursor-pointer';
  ...
  return (
    <div className="flex flex-col justify-between py-8 p-4 border-r-2 rounded-lg bg-altBackground">
      <div className="flex flex-col gap-4">
        ...
        <WalletCards
          className={clsx(
            activePage === 'accounts' ? activeStyle : inactiveStyle
          )}
          size={30}
      ...
      <div className="flex flex-col gap-4">
        <Settings
          className={clsx(
            activePage === 'settings' ? activeStyle : inactiveStyle
          )}
          size={30}
        ...
        <CircleUser
          className={clsx(
            activePage === 'profile' ? activeStyle : inactiveStyle
          )}
          size={30}
