...
const SavingAccounts: React.FC<SavingAccountsProps> = ({
  ...
  const selectedStyle =
    'bg-muted flex justify-between gap-4 rounded-lg hover:bg-muted hover:cursor-pointer';
  const notSelectedStyle =
    'flex justify-between gap-4 rounded-lg hover:bg-muted hover:cursor-pointer';
